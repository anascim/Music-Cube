...
public class GameManager: NSObject, SCNSceneRendererDelegate {
    ...
    public var arrowElementNode: SCNNode!
    public var arrowRotateElementNode: SCNNode!
    public var arrowDeletionElementNode: SCNNode!
    public var playIconNode: SCNNode!
    public var pauseIconNode: SCNNode!
    public var wipeIconNode: SCNNode!
    
    public var selectedPad: PadNode?
    
    public static var isPaused = false
    
    // HUD
    public var elementsCentralNode: SCNNode!
    ...
    public func setupScene() {
        ...
        wipeIconNode = ModelsManager.createNode(filename: "x")
