...
public enum MCDirection: CaseIterable {
    ...
    public func orientation(on face: MCOrientation) -> MCOrientation {
        switch self {
        case .x:
            switch face {
            case .forward:
    ...
    // TODO: simplify this using cross product
    public func counterClockDirection(up: MCOrientation) -> MCDirection {
        switch up {
        case .up:
            switch self {
            case .x:
