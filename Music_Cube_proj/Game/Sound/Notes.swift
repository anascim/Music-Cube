...
enum Note {
    ...
    // From c3 to c6
    static let C: [Float] = [130.81, 261.62, 523.24, 1046.5]
    static let CS: [Float] = [138.59, 277.18, 554.37]
    static let D: [Float] = [146.83, 293.66, 587.32]
    static let DS: [Float] = [155.56, 311.13, 622.25]
    static let E: [Float] = [164.81, 329.62, 659.24]
    static let F: [Float] = [174.61, 349.23, 523.25]
    static let FS: [Float] = [185, 370, 740]
    static let G: [Float] = [196, 392, 784]
    static let GS: [Float] = [207.18, 415.30, 830.61]
    static let A: [Float] = [220, 440, 880]
    static let AS: [Float] = [233.08, 466.16, 932.33]
    static let B: [Float] = [246.94, 493.88, 987.77]
    
    static var CPentatonic: [Float] = {
        return C + D + E + FS + A
    }()
    
    static var CMajor: [Float] = {
